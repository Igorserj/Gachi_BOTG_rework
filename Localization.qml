...
QtObject {
    ...
    readonly property var inventoryCellOptions: [[["Посунути", "Використати", "Викинути", "Знищити"], ["Посунути", "Екіпіювати", "Викинути", "Знищити"], ["Посунути", "Зняти"], ["Взяти", "Посунути", "Знищити"]],
                                                [["Move", "Use", "Drop", "Destroy"], ["Move", "Equip", "Drop", "Destroy"], ["Move", "Unequip"], ["Loot", "Move", "Destroy"]],
                                                [["Переместить", "Использовать", "Выбросить", "Уничтожить"], ["Переместить", "Экипировать", "Выбросить", "Уничтожить"], ["Переместить", "Снять"], ["Взять", "Переместить", "Уничтожить"]]][languages.indexOf(currentLanguage)]
}
